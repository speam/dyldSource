		...
		uintptr_t* startGlue)
{
	...
	// 主要功能2⃣️：根据Mach-O头部获取当前运行架构信息
	getHostInfo(mainExecutableMH, mainExecutableSlide);

	// load shared cache
	// 主要功能3⃣️：检查共享缓存是否开启，iOS中必须开启
...
reloadAllImages:
		...
		// 主要功能6⃣️：插入动态库:加载所有 DYLD_INSERT_LIBRARIES 指定的库
